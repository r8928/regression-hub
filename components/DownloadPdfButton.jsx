...
export default function DownloadPdfButton({ run }) {
  ...
  async function handleClick() {
    ...
    try {
      ...
      doc.setFont("helvetica", "bold");
      doc.setFontSize(11);
      doc.text("Test Run Summary", ML, y);
      y += 16;
      doc.setFont("helvetica", "normal");
      doc.setFontSize(10);
      ...
      autoTable(doc, {
        ...
        columnStyles: {
          ...
          2: { cellWidth: 46 },
          3: { cellWidth: 46, textColor: [22, 163, 74] },
          4: { cellWidth: 46, textColor: [220, 38, 38] },
          5: { cellWidth: 56, textColor: [217, 119, 6] },
          6: { cellWidth: 54 },
        },
        theme: "striped",
      });
