...
```
cd existing_repo
git remote add origin https://gitlab.com/irisvision/regression-suit-software.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/irisvision/regression-suit-software/-/settings/integrations)
...
4. Deploy
>>>>>>> 3da2612 (Initial commit: QA Regression Management)
